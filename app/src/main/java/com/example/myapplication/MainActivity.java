...
import com.example.myapplication.Fragment.CatRecyclerFragment;
import com.example.myapplication.Fragment.FavoritesRecyclerFragment;
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.search_nav) {
                    ...
                    return true;
                } else if (menuItem.getItemId() == R.id.cat_nav) {
